...
Annule l'effet d'une compétence ennemie utilisée lors du tour précédent. A noter qu'une liste des compétences ennemie utilisé durant le tour précèdent sera disponible pour choisir l'effet à cancel.
...
* L﻿e deck est limité au nombre de compétence existante
* L﻿es compétences ont désormais des niveau (de 1 à 3)
* L﻿es compétences unique ont des niveaux également + difficile à monté
* L﻿es compétences sont réinitialiser lorsqu'elle sont perdu (exemple du niveau 3 à 1)
* U﻿n classement est possible
* U﻿n abonnement ou un achat permettra d'obtenir un boost d'XP (pour les compétences) + d'obtenir des cosmétiques pour ces pièces